...
(function(exports) {
	...
	/**
	 * This function as a constructor of PinAppNavigation. It gets dom element that contains elements
	 * @param {Object} list [Container that contains pin elements]
	 */
	function PinAppNavigation(list){

		if (!list &&  typeof list !== 'object'){
			console.log('List of pin apps must be an boject');
			return;
		}
	...
	PinAppNavigation.prototype = {
		...
		/**
		 * This function reset all pinns to default vlue.
		...
		reset: function reset(){
			...
			toRemoveOutFocus ? toRemoveOutFocus.classList.remove('out-focus') : null;
		...
		handleEvent: function(e){
			...
			function cycleElements (index){
				...
				//this.elemList.style.top = '-6.5rem';
			...
			switch(e.key){
				case 'ArrowUp':
					...
					if (this.selectedElemIndex == 2) {

						cycleElements.call(this,  1);
						this.selectedElemIndex += 1;

						this.selectedElemIndex --;
						this.elements[this.selectedElemIndex].classList.add('selected');


					} else if (this.selectedElemIndex == 1) {

						cycleElements.call(this,  2);
						this.selectedElemIndex += 2;

						this.selectedElemIndex --;
						this.elements[this.selectedElemIndex].classList.add('selected');


					} else if (this.selectedElemIndex == 0){

						cycleElements.call(this,  3);
						this.selectedElemIndex += 3;
